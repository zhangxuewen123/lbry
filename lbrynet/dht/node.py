...
class Node(object):
    ...
    def joinNetwork(self, knownNodeAddresses=None):
        ...
        self.next_refresh_call = reactor.callLater(constants.checkRefreshInterval, self._refreshNode)  # IGNORE:E1101
    ...
    def change_token(self):
        ...
        self.token_secret = self._generateID()
        self.next_change_token_call = reactor.callLater(constants.tokenSecretChangeInterval, self.change_token)
    ...
    def _scheduleNextNodeRefresh(self, *args):
        self.next_refresh_call = reactor.callLater(constants.checkRefreshInterval, self._refreshNode)
...
class _IterativeFindHelper(object):
    ...
    def searchIteration(self):
        ...
        if self._should_lookup_active_calls():
            ...
            call = reactor.callLater(constants.iterativeLookupDelay, self.searchIteration)  # IGNORE:E1101
